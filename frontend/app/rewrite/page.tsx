  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-2xl px-5 py-10 sm:px-8">
        ...
        <p className="mt-2 mb-8 text-slate-600">Keep your meaning and make the message fit the person receiving it.</p>

        <form onSubmit={handleRewrite} className="flex flex-col gap-5 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
          <div>
