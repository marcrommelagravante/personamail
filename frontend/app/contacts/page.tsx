      ...
      <main className="mx-auto w-full flex-1 max-w-4xl px-5 py-8 sm:px-8 sm:py-12">
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border border-dashed border-slate-300 bg-white p-12 text-center shadow-sm dark:border-slate-800 dark:bg-slate-900/90">
            ...
            <h2 className="mt-4 font-semibold text-slate-900 dark:text-white">No contacts added yet</h2>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs leading-relaxed text-slate-600 dark:text-slate-300">
                  Are you sure you want to delete <span className="font-semibold text-slate-900 dark:text-white">{deletingContact.name}</span>? PersonaMail will no longer adapt tone and style for this contact profile.
                </p>
              </div>
            </div>
