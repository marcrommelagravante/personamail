  ...
  return (
    <>
      ...
      <main className="mx-auto w-full flex-1 max-w-4xl px-5 py-8 sm:px-8 sm:py-12">
        <div className="animate-fade-in-up mb-6">
          <span className="inline-flex items-center gap-1.5 rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-700 dark:bg-slate-800 dark:text-slate-300">
            <Clock className="h-3.5 w-3.5 text-slate-700 dark:text-slate-300" /> Recent activity
          </span>
        ...
        {!isAuthenticated ? (
          <div className="rounded-2xl border border-slate-200 bg-white p-12 text-center shadow-xs dark:border-slate-800 dark:bg-slate-900">
            ...
            <h2 className="mt-4 font-semibold text-slate-900 dark:text-white">Sign in to view history</h2>
          ...
          <>
            {error && (
              <div
                className="mb-6 flex items-center gap-2.5 rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700 dark:border-red-900/60 dark:bg-red-950/40 dark:text-red-300"
                role="alert"
              >
            ...
            {!loading && items.length > 0 && (
              <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex flex-wrap items-center gap-1.5 rounded-xl border border-slate-200 bg-white p-1 shadow-xs dark:border-slate-800 dark:bg-slate-900">
                    ...
                    >
                      ...
                      <span
                        className={`rounded-full px-1.5 py-0.2 text-[10px] ${
                          activeFilter === type
                            ? "bg-slate-800 text-sky-200 dark:bg-slate-950 dark:text-sky-300"
                  ...
                  {currentItems.map((item) => {
                    ...
                    return (
                      <article
                        ...
                        className="group flex cursor-pointer items-center justify-between gap-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-xs transition-all duration-150 hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-md dark:border-slate-800 dark:bg-slate-900/90 dark:hover:border-slate-700 active:scale-[0.99]"
                      >
                        <div className="flex items-center gap-3.5 min-w-0">
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="flex items-center gap-2">
                              <span className="rounded-md bg-slate-100 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-slate-700 dark:bg-slate-800 dark:text-slate-300">
                                {meta.title}
                              </span>
                            ...
                            <h2 className="mt-0.5 truncate font-semibold text-slate-900 group-hover:text-primary dark:text-white dark:group-hover:text-sky-400">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 rounded-xl border border-slate-300 bg-white px-3 py-1.5 text-xs font-medium text-slate-700 transition hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700 cursor-pointer"
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 rounded-xl border border-red-200 bg-red-50/50 px-3 py-1.5 text-xs font-medium text-red-600 transition hover:bg-red-100/80 dark:border-red-900/60 dark:bg-red-950/40 dark:text-red-400 dark:hover:bg-red-900/60 cursor-pointer"
                            title="Delete entry"
                          >
      ...
      {selectedItem && (
        ...
        >
          <div
            className="w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl animate-scale-in dark:border-slate-800 dark:bg-slate-900"
          ...
          >
            ...
            <div className="my-4 space-y-4 overflow-y-auto pr-1">
              <div>
                <h3 id="history-modal-title" className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">
                  Subject / Heading
                </h3>
              ...
              {selectedItem.input_text && (
                <div>
                  ...
                  <div className="mt-1.5 max-h-40 overflow-y-auto rounded-xl bg-slate-100 p-3 text-xs leading-relaxed text-slate-700 whitespace-pre-wrap border border-slate-200 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-300">
                    {selectedItem.input_text}
                  </div>
                </div>
              )}
              ...
              {selectedItem.summary && (
                <div className="rounded-xl border border-sky-100 bg-sky-50/70 p-3 text-xs text-sky-900 dark:border-sky-900/60 dark:bg-sky-950/50 dark:text-sky-300">
