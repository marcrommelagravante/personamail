  ...
  return (
    <div className="relative rounded-3xl border border-slate-200/90 bg-white p-4 shadow-xl dark:border-slate-800 dark:bg-slate-900 sm:p-6 lg:p-8">
      ...
      <div className="grid gap-6 rounded-2xl bg-slate-50 p-5 dark:bg-slate-950/70 sm:p-6 lg:grid-cols-[280px_1fr]">
        ...
        <div className="space-y-4 rounded-xl border border-slate-200/70 bg-white p-4 dark:border-slate-800 dark:bg-slate-900 transition-all duration-300">
          {feature === "contact" && genStatus === "idle" ? (
            <div className="flex h-full min-h-[120px] items-center justify-center text-center">
              <p className="text-sm text-slate-400 dark:text-slate-500">
                Contact profile empty.<br />Analyze to extract tone.
              </p>
            </div>
          ) : feature === "contact" && genStatus === "generating" ? (
            <div className="flex h-full min-h-[120px] flex-col items-center justify-center space-y-3">
            ...
            <>
              <div className="flex items-center gap-2.5">
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-sky-100 font-semibold text-primary dark:bg-sky-950 dark:text-sky-300">
                  {activeProfile.name[0]}
                </div>
                <div className="overflow-hidden">
                  <p className="truncate font-semibold text-primary dark:text-white">
                    {activeProfile.name}
                  </p>
        ...
        <div className="relative min-h-[240px] rounded-xl border border-slate-200/70 bg-white p-5 dark:border-slate-800 dark:bg-slate-900 overflow-hidden flex flex-col">
            ...
            {feature === "contact" && (
              <div className="space-y-4">
                <div>
                  ...
                  <div className="mt-2 rounded-lg bg-slate-50 p-3 text-sm text-slate-600 dark:bg-slate-950 dark:text-slate-300 font-sans border border-slate-100 dark:border-slate-800">
                    {activeProfile.contactInput}
                  </div>
                </div>
                {genStatus === "idle" && (
                  <button onClick={handleGenerate} className="inline-flex cursor-pointer items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-white transition-all hover:bg-slate-800 active:scale-95 dark:bg-sky-500 dark:text-slate-950 dark:hover:bg-sky-400 w-full sm:w-auto">
                ...
                {genStatus === "completed" && (
                  <div className="rounded-lg border border-emerald-100 bg-emerald-50/50 p-4 dark:border-emerald-900/50 dark:bg-emerald-950/20 animate-scale-in">
                    ...
                    <p className="mt-1 text-xs text-emerald-600 dark:text-emerald-400/80">
                      We&apos;ll remember that {activeProfile.name} is a {activeProfile.relationship.toLowerCase()} who prefers a {activeProfile.tone.toLowerCase()} tone.
                    </p>
                  </div>
                )}
              </div>
            ...
            {feature === "compose" && (
              <div className="space-y-4 flex flex-col h-full">
                <div>
                  ...
                  <div className="mt-2 rounded-lg bg-slate-50 p-3 text-sm text-slate-600 dark:bg-slate-950 dark:text-slate-300 font-sans border border-slate-100 dark:border-slate-800 relative">
                ...
                {genStatus === "generating" && (
                  <div className="flex items-center gap-2 text-sm font-medium text-sky-600 dark:text-sky-400 mt-4">
                    <Loader2 className="h-4 w-4 animate-spin" />
                    Composing email...
                  </div>
                )}
                ...
                {genStatus === "completed" && (
                  <div className="space-y-3 mt-4 flex-1 animate-scale-in">
                    ...
                    <div>
                      ...
                      <div className="mt-2 text-sm leading-relaxed text-slate-700 dark:text-slate-200 whitespace-pre-wrap font-sans">
              ...
              <div className="space-y-4">
                ...
                {genStatus === "completed" && (
                  <div className="mt-4 animate-scale-in">
                    ...
                    <div className="mt-2 text-sm font-medium leading-relaxed text-slate-800 dark:text-slate-100 whitespace-pre-wrap font-sans">
