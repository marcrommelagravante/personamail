...
- [x] Execute remainder of redesign plan: Extracted LandingNavbar, removed TrustPanel, integrated ClosingFooterPanel into LandingPage, and created Privacy and Tech Stack pages matching the Exaggerated Minimalism aesthetic. Verified with 0 errors on npm run lint and npm run build.
