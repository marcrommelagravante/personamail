...
- [x] Restore original PersonaMail logo PNG icons in `Logo.tsx` and enforce single-line layout (`shrink-0 whitespace-nowrap`) on the **New template** action button in `frontend/app/templates/page.tsx`.
