...
- [x] Fix logo visibility: integrated exact `logo-icon-dark-transparent.png` asset for Dark Mode and `logo-icon-transparent.png` for Light Mode in `Logo.tsx`, verified clean decoding and rendering with zero pixelation across both themes.
